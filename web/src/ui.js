...
export function setupUI(p, state, refreshCallback) {
    ...
    colscheme_sel.changed(() => {
        state.colorScheme = colscheme_sel.value();
        refreshCallback();
    });
    ...
    showOutlinesCheck.changed(() => {
        state.showOutlines = showOutlinesCheck.checked();
        refreshCallback();
    });
    ...
    showEdgeLabelsCheck.changed(() => {
        state.showEdgeLabels = showEdgeLabelsCheck.checked();
        refreshCallback();
    });
    ...
    showEdgeJoinerCheck.changed(() => {
        state.showEdgeJoiner = showEdgeJoinerCheck.checked();
        refreshCallback();
    });
